...
public class AllKatasTest {
    ...
    @Test
    public void testAgeAgainOutput() throws Exception {
    ...
    @Test
    public void testFavoriteProgrammingLanguageOutput() throws Exception {
        String[] args = null;
    ...
    @Test
    public void testIsJavaKeywordOutput() throws Exception {
        String[] args = null;
    ...
    @Test
    public void testUltimateQuestionOutput() throws Exception {
        String[] args = null;
    ...
    @Test
    public void testYourAgeCanOutput() throws Exception {
        String[] args = null;
